...
const answerContainers = Array.from(document.getElementsByClassName("answer-container"));
...
answerContainers.forEach(answerContainer => {
    answerContainer.addEventListener('click', e => {
        ...
        const selectedChoice = e.currentTarget.querySelector('.answer');
        const selectedAnswer = selectedChoice.dataset.number;
        const number = e.currentTarget.querySelector('.number');
...
function getNewQuestion(){
    ...
    progressBar.style.width = (questionCounter * 10).toString() + "%";
